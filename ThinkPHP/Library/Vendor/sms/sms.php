...
class Sms
{
	...
	public $tel;//短信接收号码
	public $parameter;//模板参数
	public $templateCode;//模板号
	public $autograph;//签名
    /**
     * 取得AcsClient
     *
    ...
    public function __construct( $tel,$templateCode,$autograph,$parameter ){
    	$this->tel = $tel;
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4G3jMa7ZpHABYsj1pvPB"; // AccessKeyId

        $accessKeySecret = "NsVl5I70soN0M8VjyLuiS3QvThuJ0N"; // AccessKeySecret
    ...
    public function sendSms() {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers( $this->tel );
        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName( $this->autograph );
        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode( $this->templateCode );
        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
        $request->setTemplateParam( $this->parameter );
